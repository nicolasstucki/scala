...
case class Tuple11[+T1, +T2, +T3, +T4, +T5, +T6, +T7, +T8, +T9, +T10, +T11](_1_st: T1, _2_nd: T2, _3_rd: T3, _4_th: T4, _5_th: T5, _6_th: T6, _7_th: T7, _8_th: T8, _9_th: T9, _10_th: T10, _11_th: T11)
